    ...
    return (
        <div className="settings-el echo-container">
            ...
            <div className='knobs-container'>
                <div className='VCF'>
                    <p>E</p>
                    <RadialSlider min={0} max={1} step={0.01} value={echoTime} updater={setEchoTime} label={echoTime}/>
                </div>
                <div className="VCF">
                    <p>F</p>
                    <RadialSlider min={0} max={1} step={0.01} value={echoFeedback} updater={setEchoFeedback} label={echoFeedback} />
                </div>
            </div>
        </div>
    )
